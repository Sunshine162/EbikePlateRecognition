...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/ebike_plate.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/ebike_plate_hyp.yaml', help='hyperparameters path')
